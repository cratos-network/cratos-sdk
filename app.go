...
var (
	...
	DefaultNodeHome = os.ExpandEnv("$HOME/.cratosd")
...
func NewCratosServiceApp(logger log.Logger, db dbm.DB, baseAppOptions ...func(*bam.BaseApp)) *CratosServiceApp {
	...
	keys := sdk.NewKVStoreKeys(bam.MainStoreKey, auth.StoreKey, staking.StoreKey,
		supply.StoreKey, distr.StoreKey, slashing.StoreKey, params.StoreKey, demosid.StoreKey)
	...
	// It handles interactions with the id store
	app.demosIDKeeper = demosid.NewKeeper(
		app.bankKeeper,
		app.accountKeeper,
		keys[demosid.StoreKey],
		app.cdc,
	)
	...
	app.mm = module.NewManager(
		...
		demosid.NewAppModule(app.demosIDKeeper, app.bankKeeper),
